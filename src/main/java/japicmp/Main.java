...
public class Main {
    ...
    private static class RunJapicmp implements Runnable {
        ...
        @CommandLine.Option(
                names = {"-o", "--old-jar"},
                paramLabel = "OLD-JAR",
                description = "The maven coordinates of the old jar file. If not provided, japicmp will be run on all " +
        ...
        @CommandLine.Option(
                names = {"-n", "--new-jar"},
                paramLabel = "NEW-JAR",
                description = "The maven coordinates of the new jar file. If not provided, japicmp will be run on all " +
                        "the breaking updates in the jar-dir."
        )
        String newJar;
